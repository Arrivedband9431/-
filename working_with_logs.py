...
if __name__ == "__main__":
    assert encrypt("this is a test"), "Flip encryption failed"
    assert decrypt("this is a test"), "Flip decryption failed"
    assert flip_encryption("this is a test"), "Flip encrypt failed"
    assert decrypt_with_flip("this is a test"), "Flip decrypt failed"
    main()